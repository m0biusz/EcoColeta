...
> **Estado:** Entrega 1 de modelagem. O aplicativo Android existente neste repositório é um projeto anterior. O PWA, a infraestrutura e o CI/CD descritos abaixo **ainda não foram implementados nem publicados**.

## Equipe
- João Eduardo Panissa
- Demais integrantes: preencher, se houver, antes da entrega.
...
O PDF para entrega é disponibilizado separadamente. [Decisões de infraestrutura](docs/pratica-extensionista-iv/infraestrutura.md).
...
### Histórico
A pasta `app/` e `Documentation.md` documentam o EcoColeta **Android** anterior. O material da Prática Extensionista IV está em `docs/pratica-extensionista-iv/`.
